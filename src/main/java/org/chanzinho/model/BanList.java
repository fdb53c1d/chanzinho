...
public class BanList {
	...
	public String toString() {
		return "BanList [id=" + id + ", type=" + type + ", expired=" + expired + ", allowRead=" + allowRead + ", ip="
				+ ip + ", ipMd5=" + ipMd5 + ", globalBan=" + globalBan + ", boards=" + boards + ", by=" + by + ", at="
				+ at + ", until=" + until + ", reason=" + reason + ", staffNote=" + staffNote + ", appeal=" + appeal
				+ ", appealAt=" + appealAt + "]";
	}
}
