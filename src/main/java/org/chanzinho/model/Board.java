...
public class Board {
  ...
  @Column(name = "enablenofile")
  private Boolean enableNoFile;
  @Column(name = "enablearchiving")
  private Integer enableArchiving;
  @Column(name = "enablecatalog")
  private Integer enableCatalog;
  @Column(name = "loadbalanceurl")
  ...
  public String toString() {
    return "Board [id=" + id + ", order=" + order + ", name=" + name + ", type=" + type + ", start="
        ...
        + ", enableNoFile=" + enableNoFile + ", enableArchiving=" + enableArchiving
        + ", enableCatalog=" + enableCatalog + ", loadBalanceUrl=" + loadBalanceUrl
        + ", loadBalancePassword=" + loadBalancePassword + "]";
  }
}
