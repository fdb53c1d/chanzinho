...
public class Post {
	...
	public String toString() {
		return "Posts [id=" + id + ", boardId=" + boardId + ", parentId=" + parentId + ", name=" + name + ", tripcode="
				+ tripcode + ", email=" + email + ", subject=" + subject + ", message=" + message + ", password="
				+ password + ", file=" + file + ", fileMd5=" + fileMd5 + ", fileType=" + fileType + ", fileOriginal="
				+ fileOriginal + ", fileSize=" + fileSize + ", fileSizeFormatted=" + fileSizeFormatted + ", imageW="
				+ imageW + ", imageH=" + imageH + ", thumbW=" + thumbW + ", thumbH=" + thumbH + ", ip=" + ip
				+ ", ipMd5=" + ipMd5 + ", tag=" + tag + ", timestamp=" + timestamp + ", stickied=" + stickied
				+ ", locked=" + locked + ", posterAuthority=" + posterAuthority + ", reviewed=" + reviewed
				+ ", deletedTimestamp=" + deletedTimestamp + ", isDeleted=" + isDeleted + ", bumped=" + bumped + "]";
	}
}
